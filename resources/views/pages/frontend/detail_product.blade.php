    ...
    <div class="flex-1">
      <div class="slider">
        <div class="thumbnail">
          ...
          <div class="px-2">
            <div class="item selected" data-img="{{ $item->url }}">
              <img src="{{ $item->url }}" alt="front" class="object-cover w-full h-full rounded-lg" />
            </div>
          </div>
          @endforeach
        </div>
        <div class="preview">
          <div class="item rounded-lg h-full overflow-hidden">
            <img src="{{ $product->galleries->first()->url }}" alt="front" class="object-cover w-full h-full rounded-lg" />
          </div>
        </div>
      </div>
    </div>
