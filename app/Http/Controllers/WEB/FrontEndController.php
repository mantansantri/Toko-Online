...
class FrontEndController extends Controller
{
    ...
    public function detailProduct($slug)
    {
        ...
        // return view('pages.frontend.detail_product', compact('nameCategory', 'product'));
    ...
    public function cart(Request $request)
    {
        ...
        return view('pages.frontend.cart', compact('nameCategory', 'product'));
    }
    ...
    public function checkout(CheckoutRequest $request)
    {
        ...
        $midtrans = [
            'transaction_details' => [
                'order_id'      => 'HAIKAL WALUYA-' . $transaction->id,
