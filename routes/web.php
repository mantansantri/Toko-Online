...
// Route::get('/detail-product/{slug}', [FrontEndController::class])->name('detailProduct');
Route::get('/detail/{slug}', [FrontEndController::class, 'detailProduct'])->name('detail-product');
